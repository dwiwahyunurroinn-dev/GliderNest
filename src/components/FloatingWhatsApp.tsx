...
export function FloatingWhatsApp({
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2.5 rounded-full bg-[#22a75d] py-3 pl-3.5 pr-4 text-white shadow-lg shadow-black/20 transition-all hover:-translate-y-0.5 hover:bg-[#1d9152] hover:shadow-xl print:hidden"
    >
