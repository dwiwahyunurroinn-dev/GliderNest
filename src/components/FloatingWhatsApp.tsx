...
export function FloatingWhatsApp({
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-40 flex items-center gap-2.5 rounded-full bg-[#22a75d] py-3 pl-3.5 pr-4 text-white shadow-lg shadow-black/20 transition-all hover:-translate-y-0.5 hover:bg-[#1d9152] hover:shadow-xl xl:bottom-5 xl:right-5 print:hidden"
    >
